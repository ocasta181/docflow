...
def test_pliage_pdf_reverse_command(tmp_path: Path, capsys) -> None:
...
def test_pliage_pdf_reverse_json_output(tmp_path: Path, capsys) -> None:
    input_pdf = create_test_pdf(tmp_path / "input.pdf", 2)
...
def test_pliage_pdf_join_command(tmp_path: Path, capsys) -> None:
...
def test_pliage_pdf_split_command(tmp_path: Path, capsys) -> None:
...
def test_pliage_pdf_command_reports_errors(tmp_path: Path, capsys) -> None:
...
def test_pliage_pdf_json_reports_errors(tmp_path: Path, capsys) -> None:
